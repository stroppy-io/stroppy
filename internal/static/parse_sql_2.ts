...
export interface ParseOptions {
  database?: "MySQL" | "PostgreSQL" | "SQLite" | "TransactSQL" | "MariaDB" | "Hive" | "DB2" | "FlinkSQL" | "Redshift" | "Athena" | "BigQuery" | "Snowflake" | "Noql";
}
...
function determineQueryType(sql: string, parser: Parser, options: ParseOptions): QueryType {
  try {
...
export function parse_sql(sqlContent: string, options: ParseOptions = {}): ParsedQuery[] {
