...
func (x *ListRunsRequest) GetOrderByTps() *Tps_OrderBy {
	if x != nil {
		return x.OrderByTps
	}
	return nil
...
const file_panel_run_proto_rawDesc = "" +
	...
	"\x0e_database_typeB\x0f\n" +
	"\r_order_by_tps2\xb3\x01\n" +
	"\n" +
	"RunService\x129\n" +
...
var file_panel_run_proto_goTypes = []any{
	...
	(*Tps_OrderBy)(nil),        // 13: panel.Tps.OrderBy
...
var file_panel_run_proto_depIdxs = []int32{
	...
	13, // 13: panel.ListRunsRequest.order_by_tps:type_name -> panel.Tps.OrderBy
	0,  // 14: panel.RunRecord.List.records:type_name -> panel.RunRecord
	1,  // 15: panel.RunService.ListRuns:input_type -> panel.ListRunsRequest
	14, // 16: panel.RunService.ListTopRuns:input_type -> google.protobuf.Empty
	0,  // 17: panel.RunService.AddRun:input_type -> panel.RunRecord
	2,  // 18: panel.RunService.ListRuns:output_type -> panel.RunRecord.List
	2,  // 19: panel.RunService.ListTopRuns:output_type -> panel.RunRecord.List
	0,  // 20: panel.RunService.AddRun:output_type -> panel.RunRecord
