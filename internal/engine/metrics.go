...
// applyStepTag adds the VU's current step tag (set by SetStepTag) to a metric's
// base tag set. Replaces k6's per-VU TagsAndMeta read.
...
func (m *txMetrics) recordQuery(vu *VU) {
