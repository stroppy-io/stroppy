        ...
        <div className="space-y-4 rounded-xl border border-border/60 bg-muted/20 p-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-1">
                    ...
                    />
                    {errors[`${errorPrefix}Cores`] &&
                        <p className="text-xs text-destructive">{errors[`${errorPrefix}Cores`]}</p>}
                </div>
                <div className="space-y-1">
                    <label className="text-xs uppercase tracking-[0.3em] text-muted-foreground">
                ...
                <div className="space-y-1">
                    ...
                    />
                    {errors[`${errorPrefix}Disk`] &&
                        <p className="text-xs text-destructive">{errors[`${errorPrefix}Disk`]}</p>}
                </div>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <Card className="space-y-4 p-6">
                    ...
                    <div className="space-y-1">
                        ...
                        {errors.databaseParameters &&
                            <p className="text-xs text-destructive">{errors.databaseParameters}</p>}
                    </div>
                ...
                <Card className="space-y-4 p-6">
                    ...
                    <div className="space-y-1">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">{t('form.parametersHint')}</p>
                        {errors.workloadParameters &&
                            <p className="text-xs text-destructive">{errors.workloadParameters}</p>}
                    </div>
