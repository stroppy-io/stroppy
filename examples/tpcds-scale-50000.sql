...
select top 100 c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Pine Grove','Midway','Sunnyside','Centerville','Hopewell') 
...
select top 100 
 ...
 where
  ...
  ca_county in ('Williamsburg city','Lincoln County','Big Horn County','Blair County','Boone County') and
...
select top 100 i_item_id
 ...
 and i_manufact_id in (778,847,822,874)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 22 and 22+10 
             or ss_coupon_amt between 12536 and 12536+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 13284 and 13284+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 93 and 93+10
          or ss_coupon_amt between 6020 and 6020+1000
...
select top 100  
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 1700 and 1700+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 70000321
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2158966469
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1954413216
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 2352681615
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1192402890
            then (select avg(ss_ext_tax)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Shoes','Jewelry') and
          i_class in ('basketball','kids','jewelry boxes')
         )
      or (i_category in ('Women','Books','Home') and
          i_class in ('dresses','reference','lighting') 
        ))
...
select top 100 distinct(i_product_name)
 ...
 where i_manufact_id between 679 and 679+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'drab' or i_color = 'rose') and
        (i_units = 'Pound' or i_units = 'Oz') and
        (i_size = 'petite' or i_size = 'small')
        ) or
        (i_category = 'Men' and
        (i_color = 'royal' or i_color = 'navajo') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '51319','34202','68972','20151','17195','29139',
                          '88517','45120','22594','26265','64986',
                          '85713','62984','23141','24853','25082',
                          '52972','62911','40804','82873','18569',
                          '50809','24642','57575','24511','38975',
                          '19528','88227','50107','59077','66311',
                          '22265','25546','87920','96547','80092',
                          '38906','94999','98386','24606','44746',
                          '89740','17334','10643','28735','53912',
                          '40566','66609','85423','85858','29742',
                          '44797','41291','68486','30029','22434',
                          '21218','51519','40572','94757','18700',
                          '57636','86552','44202','70891','12455',
                          '63425','78389','98003','21202','76596',
                          '39824','16323','40556','67208','24255',
                          '45179','71388','15386','42572','29094',
                          '11475','39297','10089','20327','93108',
                          '27536','93434','24230','47398','93930',
                          '86299','31659','69443','40280','74718',
                          '78361','49397','61774','73178','22270',
                          '31409','91034','13877','65457','33864',
                          '58083','46135','93629','21493','14054',
                          '64922','27977','24530','60539','25977',
                          '59594','28311','64681','31682','17912',
                          '40631','62220','43265','54848','18114',
                          '76042','76339','64021','38607','26230',
                          '85647','70026','29748','13089','73877',
                          '23035','80183','16978','37635','87897',
                          '78451','81908','43706','87323','62935',
                          '37985','66847','42747','12780','58095',
                          '77226','23053','54804','41541','23640',
                          '23845','79990','27973','54589','57333',
                          '41414','16220','13979','89350','72764',
                          '81573','64113','51762','60930','68026',
                          '37237','27903','39713','92163','41777',
                          '91348','56012','20422','16183','76700',
                          '88274','33811','95988','17149','86066',
                          '83611','31318','89727','33363','42761',
                          '25899','57818','20122','88557','44706',
                          '25702','10268','53902','72757','96157',
                          '50294','18031','79601','67205','14053',
                          '22764','48830','45091','29138','74067',
                          '44770','58139','62255','43728','96428',
                          '45809','83374','36944','65774','29836',
                          '24687','89451','31955','28359','27889',
                          '88486','26179','40163','67315','41579',
                          '70695','29869','41056','47027','64321',
                          '13692','35687','88842','13797','75703',
                          '13850','79430','36326','57350','49188',
                          '91085','87632','86203','96877','42195',
                          '33360','52074','19133','71205','43254',
                          '24648','61992','12694','71246','68643',
                          '33406','55989','73774','28062','19672',
                          '43600','89639','49007','60730','15296',
                          '62184','45965','18958','62832','12278',
                          '25617','78944','34973','49234','96707',
                          '66245','36378','70081','73820','58323',
                          '55172','99565','96829','21763','63085',
                          '68748','49878','38989','24419','39095',
                          '49827','46934','19481','90431','20961',
                          '70610','87414','12956','71402','71294',
                          '72850','21264','65549','28944','77644',
                          '33078','88084','50104','66658','15369',
                          '37082','54717','67325','57755','31146',
                          '14586','47025','83011','55158','40515',
                          '17927','30276','97372','14009','87562',
                          '60643','45664','13256','20800','19956',
                          '60117','13983','73581','29901','60142',
                          '29273','24810','67224','30699','96179',
                          '24615','98637','35544','54305','55719',
                          '43083','13504','94103','81910','47819',
                          '22040','98229','61584','76691','99200',
                          '23901','16277','56087','41314','42552',
                          '78682','40781','97413','12822','97842',
                          '95346','52646','34737','29586','40443',
                          '51537','27297','79941','34022','19811',
                          '74101','12856','45535','17048','38589',
                          '37294','12264','69335','18411','17449',
                          '74924','38830','47204','19468','69683',
                          '11311','12222','29839','71175')
     intersect
      select ca_zip
...
select top 100 i_item_id
 ...
 and i_manufact_id in (815,662,362,496)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Marshall County','Bronx County','Perry County','Dauphin County',
                           'Sierra County','Williamson County','Franklin Parish','Oglethorpe County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Dauphin County','Raleigh County','Jefferson Davis Parish','Oglethorpe County')
...
select top 100 c_customer_id as customer_id
 ...
 where ca_city	        =  'Clifton'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  58167
   and ib_upper_bound   <=  58167 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cyan','linen','white'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 2
...
select top 100 i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,6,3,12,5,1) and
       d_year = 1998 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('LA', 'IA', 'KS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'AK', 'PA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('UT', 'WV', 'NC')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-03-28','1998-09-09','1998-11-10')))
