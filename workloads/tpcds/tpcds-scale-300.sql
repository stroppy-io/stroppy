...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('azure','lavender','smoke','dark','puff','sandy') and
...
select top 100 c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Hopewell','Mount Pleasant','Cedar Grove','Midway','Glendale') 
...
and cc_county in ('Barrow County','Fairfield County','Franklin Parish','Walker County',
                  'Daviess County'
)
and exists (select *
...
select top 100 
 ...
 where
  ...
  ca_county in ('Atlantic County','Barbour County','Chickasaw County','Nicholas County','Wright County') and
...
select top 100 i_item_id
 ...
 and i_manufact_id in (889,796,696,710)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 33 and 33+10 
             or ss_coupon_amt between 12507 and 12507+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 173 and 173+10
          or ss_coupon_amt between 1227 and 1227+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 26 and 26+10
          or ss_coupon_amt between 5991 and 5991+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 28 and 28+10
          or ss_coupon_amt between 8244 and 8244+1000
...
select top 100  
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 1400 and 1400+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 5179976
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 601513
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1637495
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3082547
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 97557
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Home','Music','Sports') and
          i_class in ('blinds/shades','country','sailing')
         )
      or (i_category in ('Children','Men','Jewelry') and
          i_class in ('newborn','accessories','loose stones') 
        ))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '40373','10356','84311','96331','13468','56705',
                          '38929','44410','44978','86452','88564',
                          '57735','31193','65354','40658','15984',
                          '51128','35178','59805','93296','85816',
                          '99398','38750','63951','89862','58642',
                          '56175','67834','49903','50121','15085',
                          '26008','59002','52375','87642','51136',
                          '68266','12551','53122','85469','69655',
                          '16032','26358','22386','67015','60623',
                          '84984','81285','68281','26929','36325',
                          '76426','32173','36357','36818','15355',
                          '37612','97152','89872','44707','76721',
                          '88691','31773','73172','33769','85009',
                          '78230','52886','21060','85507','31212',
                          '26259','83599','70673','63684','39584',
                          '37255','32261','63021','49574','10533',
                          '87578','95326','46019','10698','81792',
                          '72515','76769','51735','50966','10522',
                          '99903','58012','14798','30180','93354',
                          '30206','96547','12982','26944','52777',
                          '30536','51047','61124','49738','31802',
                          '58463','11701','12790','54173','61616',
                          '18680','10316','67044','21552','23336',
                          '55253','62774','74187','50002','59809',
                          '26773','18422','47326','13959','60879',
                          '34489','83322','11195','43625','24796',
                          '53571','83326','51724','42095','39966',
                          '36216','65771','20495','44541','75747',
                          '61191','87465','79219','24076','65048',
                          '80265','11966','74347','51151','66696',
                          '56589','21306','15242','10682','28494',
                          '33425','11684','98633','28293','36385',
                          '48034','54048','38004','10196','91260',
                          '43399','61773','43932','15387','82834',
                          '37310','76700','28387','96017','77733',
                          '11848','36774','39061','36068','53143',
                          '92962','25793','18906','14466','88056',
                          '17275','29552','55591','95357','25332',
                          '42376','17981','22505','50876','30219',
                          '26696','84366','17936','33167','45734',
                          '54723','94137','68563','15095','35316',
                          '75637','74519','42989','11702','28109',
                          '15025','27628','34703','47598','54623',
                          '90729','12101','71386','59750','59835',
                          '13651','57552','40792','19456','61523',
                          '19560','39028','16658','20643','27726',
                          '69277','10427','98509','49707','39549',
                          '71259','57268','10193','70218','36803',
                          '32565','69091','17858','51646','21230',
                          '11747','24933','42622','93679','95848',
                          '85052','77210','40455','55934','36301',
                          '41035','29731','19225','91534','35106',
                          '23534','41835','56665','45738','58707',
                          '41572','95432','54754','14924','15441',
                          '83756','51446','62577','75474','78249',
                          '83468','22868','11690','47546','15613',
                          '92382','72025','31047','67587','58966',
                          '45936','25511','56053','34228','25701',
                          '45381','13945','66975','75423','52453',
                          '29736','96045','62529','23914','93463',
                          '34690','49344','24720','11182','21846',
                          '35015','66730','43827','17179','18284',
                          '45499','58443','54283','26567','13984',
                          '80818','58682','29277','49079','46042',
                          '10640','62567','19993','83362','82111',
                          '16877','83942','82487','92151','30075',
                          '60639','16023','25510','32658','65285',
                          '13485','54472','65650','13311','58863',
                          '72230','45778','56364','37876','46741',
                          '57754','35758','93808','27342','10397',
                          '12765','56334','22661','62166','80640',
                          '91655','16789','76958','36790','76870',
                          '64297','34014','37102','81293','37900',
                          '43086','34846','52155','53921','51533',
                          '99800','50098','19739','61173','29762',
                          '15525','90940','40102','36842','57938',
                          '92320','47738','88094','38725','46734',
                          '59987','24565','56244','32766','82609',
                          '50539','30253','49008','41571','49827',
                          '44713','44326','76155','61556')
     intersect
      select ca_zip
...
select top 100 i_item_id
 ...
 and i_manufact_id in (221,367,80,890)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Luce County','Ziebach County','Daviess County','Jefferson Davis Parish',
                           'Williamson County','San Miguel County','Franklin Parish','Kittitas County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Barrow County','Richland County','Franklin Parish','Bronx County')
...
select top 100 c_customer_id as customer_id
 ...
 where ca_city	        =  'Pleasant Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  32967
   and ib_upper_bound   <=  32967 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('antique','bisque','olive'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 7
...
select top 100 i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,4,6,3,7,10) and
       d_year = 2001 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MI', 'SD', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'OK', 'IN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('LA', 'IA', 'GA')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-02-26','1999-09-21','1999-11-19')))
