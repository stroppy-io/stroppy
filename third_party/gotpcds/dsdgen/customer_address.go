...
var CustomerAddress = &Table{
	...
	Columns: []string{
		"ca_address_sk", "ca_address_id", "ca_address_street_number",
		"ca_address_street_name", "ca_address_street_type", "ca_address_suite_number",
		"ca_address_city", "ca_address_county", "ca_address_state", "ca_address_zip",
		"ca_address_country", "ca_address_gmt_offset", "ca_location_type",
	},
