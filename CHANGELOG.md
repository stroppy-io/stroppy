...
- SIGINT and SIGTERM now cancel the running workload and trigger graceful teardown; a second signal forces immediate exit. The command exits 130 after a graceful cancellation and 1 after a forced exit. ([#148](https://github.com/stroppy-io/stroppy/pull/148))
