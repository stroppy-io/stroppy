...
// Types intentionally use four distinct names; .dst grammar does not
// constrain the names — only the count — and repeating the same token
// four times triggers the dupword linter.
const sample1 = "\n-- comment line\n" +
	"create calendar;\n" +
